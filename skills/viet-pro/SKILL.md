...
- Rà soát: đọc [review/lead.md](references/review/lead.md), các reference ngôn ngữ liên quan và `fact-check.md` khi có claim cần kiểm chứng.
...
5. An toàn xuất bản: quyền sử dụng, dữ liệu cá nhân và hành động ra ngoài vẫn nằm trong phạm vi được giao.
...
Không đưa nhật ký nội bộ dài vào câu trả lời trừ khi người dùng yêu cầu.
